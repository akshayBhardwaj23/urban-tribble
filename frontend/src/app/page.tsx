  ...
  return (
    <main className="min-h-screen bg-[#f6f4ef] text-slate-900 dark:bg-[#0c1220] dark:text-slate-100">
      <div className="relative overflow-hidden px-3 pb-8 pt-4 md:px-6">
        <HeroFloatingSet />
        <div className="mx-auto max-w-6xl rounded-[34px] border border-slate-200/80 bg-white/70 px-5 py-5 backdrop-blur-sm dark:border-slate-700 dark:bg-slate-900/45 md:px-8">
          <header className="flex items-center justify-between border-b border-slate-200/80 pb-5 dark:border-slate-700">
            ...
            <div className="flex items-center gap-2 md:hidden">
              <ThemeMenuCompact />
              <Link href="/login">
                <Button size="sm" className="rounded-lg bg-slate-900 text-white dark:bg-white dark:text-slate-900">
                  Start
                </Button>
              </Link>
            </div>
          ...
          <section className="relative pt-14 md:pt-16">
            <div className="mx-auto max-w-5xl text-center lg:max-w-4xl">
              ...
              <div className="fade-up mt-9 flex flex-wrap items-center justify-center gap-3">
                <Link href="/login">
                  <Button size="lg" className="h-11 rounded-xl bg-slate-900 px-7 text-white hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200">
                    Start Free Trial
                  </Button>
                </Link>
                <Link href="#solutions">
            ...
            <div className="relative mx-auto mt-14 max-w-5xl">
              <HeroVisual />
              <div
                className="floating hidden rounded-2xl border border-slate-200 bg-white px-3 py-2 shadow-[0_18px_38px_-20px_rgba(15,23,42,0.45)] lg:block"
                style={{ left: "-3.8rem", top: "4.2rem", transform: "rotate(-8deg)", animationDelay: "0.6s" }}
              >
              ...
              <div
                className="floating hidden rounded-2xl border border-slate-200 bg-white px-3 py-2 shadow-[0_18px_38px_-20px_rgba(15,23,42,0.45)] lg:block"
                style={{ right: "-3.3rem", bottom: "1.8rem", transform: "rotate(7deg)", animationDelay: "1.4s" }}
              >
      ...
      <section id="cta" className="mx-auto max-w-6xl px-6 py-24">
        <div className="fade-up rounded-[34px] border border-slate-200 bg-gradient-to-r from-[#eaf3ff] via-[#ede7ff] to-[#f9e7ef] px-8 py-14 text-center shadow-sm dark:border-slate-700 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 md:px-14">
          ...
          <div className="mt-8">
            <Link href="/login">
              <Button size="lg" className="h-12 rounded-xl bg-slate-900 px-8 text-white hover:bg-slate-800 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200">
                Start Free Trial
              </Button>
            </Link>
          </div>
